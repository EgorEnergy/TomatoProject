...
def open_github():
    webbrowser.open("https://github.com/EgorEnergy")
...
class ModelApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Мониторинг роста томатов")
        ...
        self.logo_label = ctk.CTkLabel(
            header_frame, text="Мониторинг роста томатов", font=("Arial Rounded MT Bold", 25)
        )

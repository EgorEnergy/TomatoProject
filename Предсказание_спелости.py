...
models_dir = r'Фото для теста/photo_2024-10-09_15-30-06.jpg'
image_path = r'Фото для теста/photo_2024-10-09_15-30-06.jpg'  # Замените на путь к изображению помидора, который хотите использовать
